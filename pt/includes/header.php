			...
			<div class="holder">
				<div class="left-header">
					...
					<select name="forma" onchange="location = this.options[this.selectedIndex].value;">
						...
						<option value="/es"><?php echo $language_spanish; ?></option>
						<option value="/ru"><?php echo $language_russian; ?></option>
						<option value="/fr"><?php echo $language_french; ?></option>
						<option value="/lt"><?php echo $language_lithuanian; ?></option>
						<option value="/de"><?php echo $language_german; ?></option>
						<option value="/id"><?php echo $language_indonesian; ?></option>
						<option value="/pt"><?php echo $language_portuguese; ?></option>
					</select>
				</div>
